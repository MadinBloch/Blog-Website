...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="{{route('dashboard')}}">
          <i class="bi bi-journal-text"></i><span> Blogs</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{route('addblog')}}">
              <i class="bi bi-circle"></i><span>Write Blog</span>
            </a>
          </li>
          <li>
          ...
          <li>
            <a href="{{route('generateblog')}}">
              <i class="bi bi-circle"></i><span>Generate Blog</span>
            </a>
          </li>
          <li>
